...
class Mundo {
	constructor(){
		...
		this.espacio = 32;
		this.img = document.createElement("img");
		this.img.src = "static/img/imagenesRuner/mundo.png";
		this.imgNube = document.createElement("img");
		this.imgNube.src = "static/img/imagenesRuner/nube.png";
		this.nx = 350;
		this.ny = 50;
		this.nd = 250;
	}
...
class Corredor extends Objeto {
	constructor(){
		...
		this.img.src = "static/img/imagenesRuner/runner.png";
...
class Virus extends Objeto {
	constructor(x){
		...
		this.siguiente = null;
		this.img.src = "static/img/imagenesRuner/virus.png";
		this.techo = this.y;
...
class Nubes extends Objeto {
	constructor(x){
		...
		this.d = this.generar(this.dmin, this.dmax);
		this.siguiente = null;
		this.img.src = "static/img/imagenesRuner/nube.png";
		this.techo = this.y;
		this.fondo = this.y+this.h;
		this.derecha = this.x+this.w;
		this.izquierda = this.x;
...
class Tiempo {
	constructor(){
		...
		this.sonido.src = "static/img/imagenesRuner/aviso.mp3";
	}
	dibujar(){
		ctx.font = "25px Arial";
...
function findeJuego(){
	...
	document.getElementById("imgbtn").src = "static/img/imagenesRuner/otravez.png";
	mundo = new Mundo();
	runner = new Corredor();
	velocidad = 50;
	velocidadSalto = 25;
