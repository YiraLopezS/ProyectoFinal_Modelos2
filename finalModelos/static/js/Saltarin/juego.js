...
var Juego = {    
    ...
    preload: function(){
        ...
        juego.load.image('fondo', 'static/img/imagenesSalt/giphy.jpg');
        juego.load.image('personaje', 'static/img/imagenesSalt/personaje1.png');
        juego.load.image('obstaculo', 'static/img/imagenesSalt/obstaculo.png');        
